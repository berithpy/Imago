...
const WORDS: readonly string[] = [
  ...
  "erizo", "escarabajo", "halcon", "flamenco", "foca", "garza", "gavilan",
  "golondrina", "gorila", "grulla", "iguana", "jabali", "jaguar",
  "lagarto", "lechuza", "leopardo", "liebre", "lince", "lobo", "loro",
  "luciernaga", "mapache", "marmota", "morsa",
  "murcielago", "nutria", "onza", "orca", "ostra", "pantera", "pato",
  "pelicano", "puma", "rana", "raton", "salmon",
  "sapo", "sardina", "serpiente", "tigre", "tiburon", "topo",
  "tortuga", "trucha", "venado", "vibora", "zorro",
